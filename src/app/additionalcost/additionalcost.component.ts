  ...
  getExtraExpenses() : void {
    ...
    additionalCosts.forEach((element) => {
      ...
      var const2: IExtraCost = {
        ...
        totalCostWithRealtor: element.properties.realtor + element.properties.notary + element.properties.landAcquisition,
